...
class RuteActivity : AppCompatActivity(), OnMapReadyCallback, DirectionCallback  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (bundle != null) {
            ...
            //viewmodel
            mainViewModels = ViewModelProvider(this, ViewModelProvider.NewInstanceFactory()).get(MainViewModels::class.java)
            mainViewModels.setDetailLocation(strPlaceId)
            progressDialog.show()
            mainViewModels.getDetailLocation().observe(this, { modelDetail: ModelDetail ->
